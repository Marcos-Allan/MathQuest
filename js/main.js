...
let pontos = sessionStorage.getItem('math_quest_points_2') ? sessionStorage.getItem('math_quest_points_2') : 0
let seconds = 0
let minutes = 0
let hours = 0
...
function hideReceiverPoints() {
    ...
    if(sessionStorage.getItem('math_quest_points_2') !== null) {
        ...
        if(e.key == '1'){
            if(eval(question.innerText) == options[0].innerText){
                ...
                pontos++
                sessionStorage.setItem('math_quest_points_2', pontos)
                setTimeout(() => {
                    answer.innerHTML = ''
                    newPergunt()
                }, 600);
        ...
        console.log(sessionStorage.getItem('math_quest_points_2'))
    }
}
...
function getPoints(name, password) {
    ...
    if(name == "lajunna" && password == "140706") {
        ...
        sessionStorage.setItem('math_quest_points_2', '1264')
        pontos = 1264
